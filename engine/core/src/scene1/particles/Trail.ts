...
import {lerp, Vec2} from "@highduck/math";
import {Time, TimeLayer} from "../../app/Time";
import {Entity, EntityComponentType} from "../../ecs";
import {F32Vector, ObjectCoolArray} from "../../ds/CoolArrays";
...
//        }
            ...
            // todo: quad-out, use fine ease function?
            const t = 1.0 - node.energy;
            const r = 1.0 - t * t;

            perp.scale(node.scale * lerp(this.settings.widthMin, this.settings.widthMax, r));
