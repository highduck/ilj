import {Alignment, BitmapFont, BitmapFontResource, Engine, TextFormat} from "@highduck/core";
import {Recta} from '@highduck/math';
import * as Easing from "@highduck/easing";
import {EaseFunction} from "@highduck/easing";
