import {lerp, Color32_ARGB, Recta, Vec2, Vec3} from "@highduck/math";
import {sweepCircles, IntersectionResult} from '@highduck/collision2d';
import {Engine} from "@highduck/core";

const SWEEP_RES = new IntersectionResult();
