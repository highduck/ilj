...
export class EntryHeader {
    ...
    entryHeaderToBinary(): Uint8Array {
        ...
        const data = new Uint8Array(Constants.CENHDR + this.fileNameLength + this.extraLength + this.commentLength);
        // "PK\001\002"
    ...
    toObject() {
        return {
            ...
            attr: this.attr,
            offset: this.offset,
            entryHeaderSize: Constants.CENHDR + this.fileNameLength + this.extraLength + this.commentLength
        };
    }
}
