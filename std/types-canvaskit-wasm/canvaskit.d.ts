...
export interface SkShaderFactory {
    ...
    MakeLinearGradient(start: SkPoint, end: SkPoint, colors: SkColor[], positions: number[], mode: TileMode, localMatrix: Matrix3x3 | null, flags: number): SkShader;

    MakeRadialGradient(center: SkPoint, radius: number, colors: SkColor[], positions: number[], mode: TileMode, localMatrix: Matrix3x3 | null, flags: number): SkShader;

    MakeTwoPointConicalGradient(start: SkPoint, startRadius: number, end: SkPoint, endRadius: number,
                                colors: SkColor[], positions: number[], mode: TileMode, localMatrix: Matrix3x3 | null, flags: number,): SkShader;
}
